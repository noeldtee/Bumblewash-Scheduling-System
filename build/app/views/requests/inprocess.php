            ...
            <div class="side-menu">
                <ul class="container">
                    ...
                    <li>
                        ...
                        <li class="sidebar-item">
                            <a href="<?= ROOT ?>/requests/inprocess" class="active">In process</a>
                        </li>
                        <li class="sidebar-item">
    ...
    <div class="main-content">
        ...
        <main>
            <div class="page-header">
                <span>In Process</span><br>
                <small>track and manage document requests that are currently being processed. </small>
            </div>
