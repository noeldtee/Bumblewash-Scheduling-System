            ...
            <div class="side-menu">
                <ul class="container">
                    ...
                    <li>
                        ...
                        <li class="sidebar-item">
                            <a href="<?= ROOT ?>/requests/pending" class="active">Pending</a>
                        </li>
                        <li class="sidebar-item">
                    ...
                    <li>
                        ...
                        <i class="fa-solid fa-user" style =" margin-right: 9px;"></i>
    ...
    <div class="main-content">
        ...
        <main>
            <div class="page-header">
                <span>Pending Requests</span><br>
                <small>List of all pending requests</small>
            </div>
