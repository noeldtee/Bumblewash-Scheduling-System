            ...
            <div class="side-menu">
                <ul class="container">
                    ...
                    <li>
                        ...
                        <li class="sidebar-item">
                            <a href="<?= ROOT ?>/payments/setting" class="active">Payment Settings</a>
                        </li>
                    </ul>
                    </li>
                    <li>
    ...
    <div class="main-content">
        ...
        <main>
            <div class="page-header">
                <span>General Payment Settings</span><br>
                <small>Provide admins with control over payment-related configuration</small>
            </div>
